...
if (isset($_POST['add_product'])) {
    ...
    if ($select_products->rowCount() > 0) {
        ...
        if ($image_size > 2000000) {
            ...
            $insert_product = $conn->prepare("INSERT INTO `menu`(name, category, price, image_url, restaurant_id, restaurant_name) VALUES(?,?,?,?,?,?)");
            $insert_product->execute([$name, $category, $price, $image, $restaurant_id, $restaurant_name]);
...
<body>
   ...
   <section class="add-products">
      <form action="" method="POST" enctype="multipart/form-data">
         ...
         <input type="text" required placeholder="enter restaurant name" name="restaurant_name" class="box">
      ...
      <input type="text" required placeholder="Enter food description" name="description" maxlength="5000" class="box">
         <input type="number" min="1" required placeholder="enter restaurant ID" name="restaurant_id" class="box">
      ...
      ?>
            <div class="box">
               ...
               <div class="restaurant-info">
                  <div class="restaurant-name"><?= $fetch_products['restaurant_name']; ?></div>
                  <div class="restaurant-id">ID: <?= $fetch_products['restaurant_id']; ?></div>
               </div>
               <div class="flex-btn">
